    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="text-2xl font-semibold text-gray-800">{{ $totalAssigned }}</div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="text-2xl font-semibold text-gray-800">{{ $pendingCount }}</div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="text-2xl font-semibold text-gray-800">{{ $inProgressCount }}</div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="text-2xl font-semibold text-gray-800">{{ $completedCount }}</div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="text-2xl font-semibold text-gray-800">{{ $overdueCount }}</div>
            </div>
        </div>
