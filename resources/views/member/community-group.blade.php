    ...
    <body class="bg-gray-50 font-sans antialiased">
        <div class="min-h-screen">
            @section('header')
                <header class="bg-white shadow-sm">
                    <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
                        <div>
                            <h1 class="text-xl font-semibold text-gray-900">Community Group Attendance</h1>
                            <p class="text-sm text-gray-500">Track your Community Group's participation</p>
                        </div>
                        <button class="bg-primary hover:bg-secondary text-white px-4 py-2 rounded-md text-sm">
                            <i class="bi bi-plus mr-1"></i> Add Community Group Member
                        </button>
                    </div>
                </header>
            @endsection
            ...
            <main class="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
                <!-- Community Group Member Cards -->
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    <!-- Community Group Member 1 -->
                    <div class="bg-white rounded-lg shadow-md p-6 text-center Community Group-member-card">
                ...
                <!-- Community Group Attendance Summary -->
                <div class="bg-white rounded-lg shadow overflow-hidden mb-6">
                    <div class="p-4 border-b border-gray-200">
                        <h2 class="text-lg font-semibold">Community Group Attendance Summary</h2>
                    </div>
                    <div class="p-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <!-- Community Group Member Comparison -->
                            <div class="bg-gray-50 p-4 rounded-lg">
                                <h3 class="text-md font-medium mb-3">Community Group Member Comparison</h3>
                                <div class="space-y-2">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                ...
                <!-- Recent Community Group Attendance -->
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    <div class="p-4 border-b border-gray-200 flex justify-between items-center">
                        <h2 class="text-lg font-semibold">Recent Community Group Attendance</h2>
