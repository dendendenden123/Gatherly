...
<head>
    ...
    <title>My Attendance | Grace Community Church</title>
...
<body class="bg-gray-50 font-sans antialiased">
        ...
        <header class="bg-white shadow-sm">
            <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Track your participation history</p>
                </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between">
                                    ...
                                    <span
                                        class="text-sm bg-green-100 text-green-800 px-2 py-1 rounded-full">Present</span>
                                </div>
    ...
    <script>
        ...
        setTimeout(() => {
            ...
            if (progressCircle) {
                progressCircle.style.strokeDashoffset = '15';
            }
        }, 500);
    </script>
</body>
