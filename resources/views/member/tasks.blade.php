...
<head>
    ...
    <title>Tasks | Grace Community Church</title>
        ...
        <header class="bg-white shadow-sm">
            <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
                ...
                <button class="bg-primary hover:bg-secondary text-white px-4 py-2 rounded-md text-sm">
                    <i class="bi bi-plus mr-1"></i> New Task
                </button>
            </div>
        </header>
                        ...
                        <div class="grid grid-cols-12 gap-4 items-center">
                            <div class="col-span-1 flex justify-center">
                                <label class="inline-flex items-center">
                                    ...
                                    <span
                                        class="checkmark w-5 h-5 border border-gray-300 rounded inline-block relative"></span>
                                </label>
                            </div>
